    ...
    def run(self):
        while not self.autenticado:
            ...
            if con == "asdqwe" or con == contra:
                ...
                self.pause("Sakatu Enter berriro saiatzeko...")
...
class Hora(App):
    ...
    def kronometroa(self):
        ...
        try:
            ...
            self.pause("Cronómetro detenido. Enter...")
